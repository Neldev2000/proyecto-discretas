...
<Dialog.Title class="text-3xl">Cifrado de Cesar</Dialog.Title>
...
<div class="text-lg">
	...
	<p>
		...
		comunicarse con sus generales en medio de una batalla. Creando asi el primer cifrado conocido en
		la historia.
	</p>
	...
	<p>
		...
		Tome cada letra del mensaje original y la desplacemos hacia abajo en el alfabeto 4 posiciones. Si
		la letra pasa de la «Z», se vuelve al principio del alfabeto.
	</p>
	...
	<p>
		Supongamos que queremos cifrar la palabra <strong>«HOLA»</strong> utilizando un desplazamiento
		de 4 posiciones. Asi quedaria nuestro mensaje cifrado: <br /> <br />
	</p>
	...
	<br />
	<p>
		Ahora en el caso de que queramos revertir el mensaje simplemente debemos hacer un desplazamiento
		a la izquierda el mismo numero de veces que lo hicimos para cifrarlo. Nuestro ejemplo quedaria
		asi: <br /> <br />
	</p>
	<Table.Root class="">
		<Table.Header>
	...
	<p class="mt-5">
		Como vemos, el descifrar este mensaje es relativamente sencillo, incluso para personas que
		puedan interceptar nuestros mensajes, solo deberian hacer un maximo de 26 desplazamientos para
		poder descifrarlo. <br />
		Es por eso que este metodo es considerado como uno de los mas inseguros en la actualidad. y sirve
		como metodo educativo para comprender los cifrados mas complejos.
	</p>
	<br />
	...
	<div class="w-full flex justify-center gap-x-40 items-center mb-20 p-5">
		<div class="flex flex-col gap-y-5 w-1/2 justify-center items-center">
			<h1 class="font-medium">Seleccion los desplazamientos que deseas para cifrar tu mensaje</h1>
			<PaginacionCesar />
		</div>
		<div class="flex flex-col gap-y-5 w-1/2 justify-center items-center">
